...
function ProductList({ onHomeClick }) {
  ...
  const styleObjUl = {
    display: "flex",  
    justifyContent: "flex-end", // Changed from space-between to flex-end    alignIems: "center",
    alignItems: "center",
width: "100%",  // Set to 100% to fill the space  };,
  gap: "40px"       // Adds space between the 'Plants' link and the Cart
};
const styleA = {
    color: "white",
    fontSize: "30px",
  ...
  <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
    <h1 className="cart">
      {/* This is the badge that shows the number */}
